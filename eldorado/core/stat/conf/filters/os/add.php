 ...
 ****************************************************************/
 ...
 if (isset($_POST) && $action == "add") {
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("INSERT INTO wc_os (name, text) VALUES ('$name', '$text');");
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("UPDATE wc_os SET name='$name', text='$text' WHERE id=$id LIMIT 1;");
	 ...
	 $res=$core->exec("SELECT * FROM wc_os WHERE id=$id LIMIT 1;");
