 ...
 ****************************************************************/
 ...
 if (isset($_POST) && $action == "add") {
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("INSERT INTO wc_color (name, text) VALUES ('$name', '$text');");
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("UPDATE wc_color SET name='$name', text='$text' WHERE id=$id LIMIT 1;");
	 ...
	 $res=$core->exec("SELECT * FROM wc_color WHERE id=$id LIMIT 1;");
