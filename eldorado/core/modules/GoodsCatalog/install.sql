DROP TABLE IF EXISTS el_gcat_{pageID}_cat;
CREATE TABLE el_gcat_{pageID}_cat (
...
INSERT INTO el_gcat_{pageID}_cat (_left, _right, level, name) VALUES (1,2,0, '{pageName}');

DROP TABLE IF EXISTS el_gcat_{pageID}_item;
CREATE TABLE el_gcat_{pageID}_item (
  id int(3) NOT NULL auto_increment,
  name varchar(250) NOT NULL,
...
DROP TABLE IF EXISTS el_gcat_{pageID}_i2c;
CREATE TABLE el_gcat_{pageID}_i2c (
