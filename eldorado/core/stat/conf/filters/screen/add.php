 ...
 ****************************************************************/
 ...
 if (isset($_POST) && $action == "add") {
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("INSERT INTO wc_screen (name, text) VALUES ('$name', '$text');");
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("UPDATE wc_screen SET name='$name', text='$text' WHERE id=$id LIMIT 1;");
	 ...
	 $res=$core->exec("SELECT * FROM wc_screen WHERE id=$id LIMIT 1;");
