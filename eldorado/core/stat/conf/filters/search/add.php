 ...
 ****************************************************************/
 ...
 if (isset($_POST) && $action == "add") {
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("INSERT INTO wc_search (name, value, text) VALUES ('$name', '$val', '$text');");
	 ...
	 if ($error == "") {
		 ...
		 $core->exec("UPDATE wc_search SET name='$name', value='$val', text='$text' WHERE id=$id LIMIT 1;");
	 ...
	 $res=$core->exec("SELECT * FROM wc_search WHERE id=$id LIMIT 1;");
