...
class elModuleAdminDocsCatalog extends elModuleDocsCatalog
{
  var $_mMapAdmin = array(
	  'edit'       => array('m'=>'editCat',  'g'=>'Actions', 'l'=>'New category', 'ico'=>'icoCatNew'),
	  'edit_item'  => array('m'=>'editItem', 'g'=>'Actions', 'l'=>'New item',      'ico'=>'icoDocNew'),
	  'rm'         => array('m'=>'rmCat'),
	  'up'         => array('m'=>'moveUp'),
	  'down'       => array('m'=>'moveDown'),
	  'rm_item'    => array('m'=>'rmItem'),
	  'sort'       => array('m'=>'sortItems',       'g'=>'Actions', 'l'=>'Sort documents in current category',  'ico'=>'icoSortAlphabet'),
	  'rm_group'   => array('m'=>'rmItems',         'g'=>'Actions', 'l'=>'Delete group of documents',           'ico'=>'icoDocGroupRm'),
